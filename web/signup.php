...
<body class="text-center">
    <form class="form-signin rounded border border-danger">
      ...
      <input type="text" id="inputNom" class="form-control input-text mb-1" placeholder="" required autofocus>
      
      <label for="inputPrenom" class="float-left mb-1">Prénom : </label>
      <input type="text" id="inputPrenom" class="form-control input-text mb-1" placeholder="" required autofocus>

      <label for="inputEmail" class="float-left mb-1">Courriel :</label>
      <input type="email" id="inputEmail" class="form-control bootstrap-overrides mb-1 rounded" placeholder="" required autofocus>

      <label for="inputPassword" class="float-left mb-1">Mot de passe :</label>
      <input type="password" id="inputPassword" class="form-control bootstrap-overrides mb-3 rounded" placeholder="" required>

       <label for="inputPasswordConfirmation" class="float-left mb-1">Confirmation :</label>
      <input type="password" id="inputPasswordConfirmation" class="form-control bootstrap-overrides mb-3 rounded" placeholder="" required>
